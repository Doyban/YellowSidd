Quintus.ActionPlatformerEnemy = function(Q) {
        ...
        added: function() {
            ...
            entity.on("bump.left, bump.right, bump.bottom", function(collision) {
                if (collision.obj.isA("Player")) {
                    ...
                    //collision.obj.dead(); // Uderzenie playera z prawej, lewej, od gory = obrazenia.
                }
            });

            entity.on("bump.top", function(collision) {
                if (collision.obj.isA("Player")) {
                    collision.obj.p.vy = -100; // Podczas uderzenia przeciwnika od gory bohater odskakuje w gore.

                    Q.audio.play('kill-enemy.mp3'); // Dzwiek po zabiciu przeciwnika.
    ...
    Q.Sprite.extend("GroundEnemy", {
        ...
        step: function(dt) {
            // Przeciwnik ma chodzic w 1 strone i w 2, w innym wypadku umarl.
            ...
            // Jak jestesmy na gruncie i nie ma wypuklych przeszkod.
            if (!nextTile && ground) {
                if (this.p.vx > 0) {
